...
type FullNode interface {
	...
	StateCall(context.Context, *types.Message, types.TipSetKey) (*SimulationResult, error)
	StateReplay(context.Context, types.TipSetKey, cid.Cid) (*SimulationResult, error)
